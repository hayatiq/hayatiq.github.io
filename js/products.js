...
const PRODUCTS = [
  ...
  },
  {
    ...
    price: 700,
    category: "Hair Care",
    images: ["./images/SilkRoot_shampoo_bar.jpeg"],
  ...
  },
  {
    ...
    price: 550,
    category: "Hair Care",
    images: ["./images/rose_mint_clove_scalp_elixir.jpeg"],
  ...
  },
  {
    ...
    name: "Biodegradable Floss",
    subtitle: "Refill",
    slug: "biodegradable-floss-refill",
    price: 180,
    category: "Oral Care",
    images: ["./images/placeholder.webp"],
    short: "Biodegradable dental floss refill.",
    ingredients: [],
    how: [],
    tips: [],
    warns: PLACEHOLDER_WARNS,
  ...
  // ---- Cleaning Supply ----
  {
    ...
    images: ["./images/placeholder.webp"],
    short: "A non-toxic solid dish soap bar.",
    ingredients: [],
    how: [],
    tips: [],
    warns: PLACEHOLDER_WARNS,
  ...
  },
  {
    ...
    name: "Non Toxic Solid Dish Soap",
    subtitle: "500g Block",
    slug: "dish-soap-block-500g",
    price: 750,
    category: "Cleaning Supply",
    images: ["./images/placeholder.webp"],
    short: "A non-toxic solid dish soap, 500g block.",
    ingredients: [],
    how: [],
    tips: [],
    warns: PLACEHOLDER_WARNS,
